...
-   `actionDustGravity` (Default: `0.002`): Controls the fall speed of debris hitting surfaces.<br>
...
-   `tremorMaxGravity` (Default: `0.04`): Adjusts the weight of debris at the center.<br>
-   `tremorMinGravity` (Default: `0.001`): Adjusts the weight of debris at the outer edge.<br>
...
-   `heavyLandingAmbientPush` (Default: `0.001`): Controls the shockwave force that pushes ambient dust away when you land.<br>
